...
class HamburgerMenu extends Component {
  constructor(props) {
    ...
    this.state = {
      checked: document.getElementById("test")
    ...
    return (
      <div className="hamburger">
        ...
        <div className={toggleShow}>
          <button>
            <a href="#mission">Mission and Purpose</a>
          </button>
          <button
            onClick={() => {
              this.uncheck();
          ...
          >
            <Link to={"/preservation"}>Preservation and Practice</Link>
          </button>
          <h2>Mokupuni (Island)</h2>
          <DropdownContainer id="mokupuni">
            <button
              onClick={() => {
                this.setBoxName("niihau");
                this.showNav("niihau");
              }}
            >
              Niʻihau
            ...
            <DropdownContainer id="kauai" className="moku">
              ...
              <DropdownContainer id="puna" className="ahupuaa">
                ...
                <DropdownContainer id="wailua" className="info">
                  ...
                  <button
                    onClick={() => {
                      this.setBoxName("wailua-sites");
                      this.showNav("wailua-sites");
                    }}
                  >
                    Sites
                  </button>
                  <DropdownContainer id="wailua-sites" className="sites">
                    <ul>
                      <li>
                        <a href="#">Wailua River</a>
                      </li>
                      <li>
                        <a href="#">Wailua Beach</a>
                      </li>
                      <li>
                        <a href="#">Lydgate</a>
                      </li>
              ...
              <button
                onClick={() => {
                  this.setBoxName("halelea");
                  this.showNav("halelea");
                }}
              >
                Haleleʻa
              </button>
            ...
            <button
              onClick={() => {
                this.setBoxName("molokai");
                this.showNav("molokai");
              }}
            >
              Molokaʻi
            </button>
            ...
            <button
              onClick={() => {
                this.setBoxName("kahoolawe");
                this.showNav("kahoolawe");
              }}
            >
              Kahoʻolawe
            </button>

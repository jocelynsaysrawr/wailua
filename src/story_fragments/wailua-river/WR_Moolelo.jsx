...
export const WR_Moolelo = () => {
  return (
    <React.Fragment>
      <p>
        Wailua River is rich with history and appears in many moʻolelo. Some of
        the most famous being:
      </p>
      <br />
      <div className="indented">
        <p>"Story of Pikoiakaalala" (Fornander, Beckwith, Knudsen)</p>
        <p>"The Legend of Kila" (Fornander)</p>
        <p>"The History of Moikeha" (Fornander)</p>
        <p>"Legend of Kapakohana" (Fornander)</p>
        <p>"Legend of Kawelo" (Hooulumahiehie, Fornander)</p>
        <p>"Kawelu, the Shark God" (Knudsen)</p>
        <p>"The Footbridge of Wailua" (Wichman) </p>
        <p>"Legend of Kuapakaa" (Fornander)</p>
        <p>"Pele and Hiiaka" (Pele and Hiʻiaka)</p>
        <p>"History of Kualii" (Fornander)</p>
        <p>“Legend of Kapakohana” (Fornander)</p>
        <p>"The Story of Laieikawai" (Kalakaua)</p>
      </div>
      <br />
      <p>
        One problem can be seen with mo‘olelo however, and that is, it is not a
        fixed text where the words are freer and more interchangeable. Whereas,
      ...
      <p className="centered">
        <strong>Ka wai hālau o Wailua</strong>
      </p>
      ...
      <br />
      <p>
        This ʻōlelo noʻeau speaks of the numerous streams and tributaries along
        the north and south forks of the Wailua river.{" "}
      </p>
      <br />
      <p>
        <strong>The Upper North Branch of the Wailua River</strong> drainage
        basin is 17.9 square miles and its source is the base of Wai‘ale‘ale &
        Kawaikini. Major streams on this North Branch include Keāhua,
        ʻUhauʻiole, Kāwī and Kalama
      </p>
      <br />
      <p>Some of the most famed placed along the Wailua river include:</p>
      <br />
      <p>
      ...
      <br />
      <p>
        There are three waterfalls along the upper north branch,{" "}
        <strong>Kapapa-iki, Kapapanui, and Koholālele.</strong>
      </p>
      <br />
      <p>
        <strong>Koholālele</strong> the waterfall in the north branch of Wailua
        river. The name literally means leaping whale. Koholālele is also a
        large pond dammned to flood high taro patches. This Is the middle of
        Ka-lua-hole branch between Ka-malu and Pu‘upilo. (Kaneka, Ka‘iu, Pukui
        and Elbert)
      </p>
      <br />
      <p>
        <strong>Wai-hu‘ahu‘a</strong> is a river section of the north fork of
        the Wailua river between Pu‘upilo and ‘A‘ahoaka. The name literally
        means foaming water. (Ka‘iu)
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        <strong>The Upper South Branch of Wailua River</strong> include the
        major tributaries and streams of{" "}
        <strong>
          Hāliʻi, ʻIli-ʻili-ʻula, Ka-ulu, Pali-kea, Wai-ahi, Wai-aka, Wai-koko,
          ʻOpeʻopeʻilio,
        </strong>{" "}
        lastly and the most famed, <strong>Kawelowai</strong>, also a place
        above Wailua Falls which has several legends associated with it (Kaʻiu,
      ...
      <br />
      <p>
        <strong>Molo-hua</strong> is an area just north of the river mouth. The
        name literally means traveling flower.{" "}
      </p>
      <br />
      <p>
        <strong>Manamana-i-aka-luea</strong> was a known lehua tree in ancient
        times. This was the lehua tree that never bore flowers and grew across
        the river from Māmā-akua-lono. All its flowers appeared in the water and
        floated down stream and could be seen under the water at the surf of
        Ka-luawehe, in the sea fronting Hauola. Emerson, however, says the
        flowers floated to Lehua-wehe. (Emerson, Dickey)
      </p>
      <br />
      <p>
        <strong>Ke-kukui-ala-o-Kamaʻalau</strong> was a grove of Kukui trees,
        now gone. The place name literally means, the fragrant kukui grove of
      ...
      <br />
      <p>
        <strong>Ka-lua-Mokila</strong> is a cave that runs under Pu‘ukī hill
      ...
      <br />
      <p>
        The brackish water of Wailua river would seem like a strange place to
        find sharks. Yet numerous mo‘olelo tell of at least three sharks that
        lived there. Kū-hai-moana, Kauela, and Kawelo-mahamaha-iʻa.{" "}
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        Kauela, is another shark who used to live in the cave near the mouth.
        The present-day cement bridge was built over it and Kauela has had to
        find a new home.
      </p>
      <br />
      <p>
        Kawelo-mahamaha-i‘a was the Mōʻī of Kauaʻi during the 17th century. He
        is responsible for reintroducing the pi‘o rank, the highest possible
        rank because the child was the product of a marriage between brother and
        sister. If the shadow of a pi‘o fell on an object, the object then
        belonged to the pi‘o; if the shadow fell on a living thing; it was
        killed. Usually pi‘o went outdoors only at night. Because of this, after
        his death, stories grew that Kawelo-mahamaha-i‘a was part shark/ part
        man and in his shark form lived in his house shaped rock.{" "}
        <strong>Ka-hale-o-Kawelomahamaha-i‘a</strong> is a large house-shaped
        stone in the river below the cave of Māmā-akua-lono near the junction of
        the two branches of Wailua and a large stone on the shore. Both are
        somewhat shaped like a grass house. Both are called{" "}
        <strong>Ka-hale-o-Kawelo-mahamaha-i‘a.</strong>
      </p>
    </React.Fragment>
  );
};

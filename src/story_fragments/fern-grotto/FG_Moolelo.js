    ...
    <React.Fragment>
      <p>
        ...
        <a
          ...
          href="http://www.useapencil.org/soehren/multiprocess.php?boolean1=1&terms1=wailua&fields1=1&booleanb1=1&boolean2=1&terms2=&fields2=3&booleanb2=1&boolean3=1&terms3=&fields3=2"
        >
          Wailua river
        </a>
        , just above the junction with the north branch. Long streamers of
        Boston Sword surround and hand down over the opening of this cave giving
        it the contemporary name “The Fern Grotto”. The traditional name of this
        cave is Māmā-akua-Lono. The name literally means the chewing god lono{" "}
        <a>(Hoʻomanawanui)</a> or quickness of the god Lono.
      </p>
      <br />
      <p>
      ...
      <p className="indented">
        ...
        lived in a cave on the sheer cliff of{" "}
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="http://www.useapencil.org/soehren/process.php?terms1=mauna+kapu&boolean1=1"
        >
          Mauna Kapu
        </a>{" "}
        above her. She had two other bird kupua brothers, Kōlea and ʻŪlili, and
        after their deaths her brothers became three large pōhaku that overlook
        the cave.
      </p>
      <br />
      <p>
        This moʻolelo was derived from a longer version provided by{" "}
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://www.worldcat.org/title/more-kauai-tales/oclc/37691047"
        >
          Wichman (1997, Pg 77)
        </a>
        :
      ...
      <p className="indented">
        ...
        dammed up the river which slowly began to create a large reservoir.
      ...
      <p className="indented">
        ...
        women found her there and brought her to be a wife to their brother
      ...
      <p>
        ...
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="http://www.kauaihistoricalsociety.org/wp-content/uploads/2014/12/ms_64_lahinaluna_student_papers_1885.pdf"
        >
      ...
      <br />
      <p className="indented">Aole i paa-</p>
      <br />
      <p className="indented">
        A lohe kaikunane i ka leo o ke kaikuahine, a uwe aku la penei,
      </p>
      <br />
      <div className="double-indented">
      ...
      <br />
      <p className="indented">Oia ka moolelo o ia haiau o Niolopua.</p>
      <br />
      <p className="italic">
        <a
          target="_blank"
      ...
      <br />
      <p className="indented">
        The brother heard his sister’s voice and creid out to her:
      </p>
      <br />
      <div className="double-indented">
      ...
      <br />
      <p className="indented">
        This is a short tale of [builder of the] heiau of Niolopua.{" "}
      </p>
    </React.Fragment>
  );
};
